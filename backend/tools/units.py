"""Unit conversion tool covering length, mass and temperature."""

from __future__ import annotations

from .base import tool

# Everything is normalised to a base unit, then scaled to the target.
...
# Map common spellings the model may produce to the canonical symbols above.
_ALIASES = {
...
@tool(
    description="Convert a value between units of length (mm, cm, m, km, in, ft, "
    "mi), mass (mg, g, kg, lb, oz) or temperature (c, f, k).",
    parameters={
        "type": "object",
        "properties": {
            "value": {"type": "number", "description": "The numeric value."},
            "from_unit": {"type": "string", "description": "Source unit symbol."},
            "to_unit": {"type": "string", "description": "Target unit symbol."},
        },
