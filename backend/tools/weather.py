"""Live weather lookup via the free Open-Meteo API — LangChain tool."""
...
def get_weather(city: str) -> str:
    """Get the current weather (temperature and conditions) for a city. Use this whenever the user asks about weather."""
    try:
